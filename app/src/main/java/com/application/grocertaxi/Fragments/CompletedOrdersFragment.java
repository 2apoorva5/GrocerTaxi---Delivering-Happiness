...
public class CompletedOrdersFragment extends Fragment {
    ...
    private CollectionReference userCompletedOrdersRef;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        userCompletedOrdersRef = FirebaseFirestore.getInstance().collection(Constants.KEY_COLLECTION_USERS)
    ...
    private void loadCompletedOrders() {
        ...
        completedOrderAdapter = new FirestorePagingAdapter<Order, CompletedOrderViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CompletedOrderViewHolder holder, int position, @NonNull Order model) {
                ...
                holder.orderCompletedTime.setText(String.format("Delivered on %s", model.getOrderPlacedTime()));
    ...
    public static class CompletedOrderViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView orderID, orderCompletedTime, noOfItems, orderTotalPayable, orderStoreName;
